...
// src/error.ts
var MissingRequiredKeyError = class extends Error {
  constructor(key) {
    super();
...
// src/base.ts
var CaseCopyMap = class extends Map {
  set(key, value) {
...
// src/control.ts
var BinaryControl = class extends APTBase {
  ...
  constructor(rawData, options) {
    ...
    this.installedSize = installedSize !== 0 ? installedSize : void 0;
...
// src/packages.ts
var Package = class extends BinaryControl {
  // Begin Raw Implementation
  filename;
  size;
  md5;
...
var Packages = class extends Array {
...
// src/release.ts
var Release = class extends APTBase {
  // Begin Raw Implementation
  architectures;
  noSupportForArchitectureAll;
  description;
  origin;
  label;
  suite;
  ...
  constructor(rawData, options) {
    ...
    this.version = map.get("Version")?.trim();
    this.date = map.get("Date") ? new Date(map.get("Date")) : void 0;
    this.validUntil = map.get("Valid-Until") ? new Date(map.get("Valid-Until")) : void 0;
    ...
    for (const [key, value] of map) {
      ...
      const indice = this.getHashIndex(key);
      this[indice] = hashmap;
    }
  }
  /**
  ...
  for (const line of lineChunks) {
    ...
    if (!match) {
      if (cleanLine.endsWith(":")) {
        const key2 = cleanLine.slice(0, -1);
        fields.set(key2, "");
        previousKey = key2;
      } else if (previousKey !== "") {
